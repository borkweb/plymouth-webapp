...
/**
 * StatsD-compatible interface to PSU\Config.
 */
class Config {
    protected $config;
    ...
    public function getConfig( $key ) {
        switch( $key ) {
            case "statsd.host": return $this->config->get( 'statsd', 'host');
            case "statsd.port" : return $this->config->get( 'statsd', 'port');
            case "statsd.enabled" : return $this->config->get( 'statsd', 'enabled');
        }
    }

    public function isEnabled() {
        return $this->getConfig( 'statsd.enabled' );
    }

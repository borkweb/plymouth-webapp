        ...
        if ($this->_ad_username!=NULL && $this->_ad_password!=NULL){
            ...
            if (!$this->_bind){
                if ($this->_use_ssl && !$this->_use_tls){
                    ...
                    throw new adLDAPException('Bind to Active Directory ('.$dc.') failed. Either the LDAPs connection failed or the login credentials are incorrect. AD said: ' . $this->get_last_error());
                } else {
                    throw new adLDAPException('Bind to Active Directory ('.$dc.') failed. Check the login credentials and/or server details. AD said: ' . $this->get_last_error());
                }
            }
        }

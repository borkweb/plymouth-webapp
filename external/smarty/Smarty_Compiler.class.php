...
class Smarty_Compiler extends Smarty {
    ...
    function Smarty_Compiler()
    {
        ...
        // http://code.google.com/p/smarty-php/issues/detail?id=3#c4
        $this->_obj_ext_regexp = '(?:\(.*?\))?\->(?:\$?' . $this->_dvar_guts_regexp . ')'; $this->_obj_restricted_param_regexp = '(?:' . '(?:' . $this->_var_regexp . '|' . $this->_num_const_regexp .  ')(?:' . $this->_obj_ext_regexp . '(?:\((?:(?:' . $this->_var_regexp . '|' .  $this->_num_const_regexp . ')' . '(?:\s*,\s*(?:' . $this->_var_regexp . '|' .  $this->_num_const_regexp . '))*)?\))?)*)';
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        $search = "~{$ldq}\*(.*?)\*{$rdq}|{$ldq}literal\s*{$rdq}(.*?){$ldq}/literal\s*{$rdq}|{$ldq}php\s*{$rdq}(.*?){$ldq}/php\s*{$rdq}~s";
        ...
        $text_blocks = preg_split("~{$ldq}\S.*?{$rdq}~s", $source_content);

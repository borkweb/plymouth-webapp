...
$.root=$(document),$(function(){if(typeof HOST=="string"){var a=document.createElement("script");a.type="text/javascript",document.body.appendChild(a),a.src=HOST+"/webapp/my/js/konami.js"}typeof $.fn.dropDownMenu=="function"&&$(".webapp-nav ul:first").dropDownMenu({timer:500,parentMO:"parent-hover",childMO:"child-hover1"}),$(".webapp-nav ul ul ul").parent().children("a").addClass("menu-expand"),$.fn.tablesorter&&$("table.sortable").tablesorter()}),$("#return-to-top").live("click",function(a){a.preventDefault(),$("html, body").animate({scrollTop:0},"fast")}),$.psu=$.psu||{},function(){this.psu={host:null},typeof HOST=="string"?this.psu.host=HOST:(this.psu.host=document.location.protocol+"//",".dev.plymouth.edu"==document.location.host.substr(-17)?this.psu.host=this.psu.host+"www.dev.plymouth.edu":this.psu.host=this.psu.host+"www.plymouth.edu")}(),function(a){function d(){var c={},d=[],f;while(node=b.shift()){f=a(node);var g=f.data("id");typeof c[g]=="undefined"?c[g]=f:c[g]=c[g].add(f),d.push(g);if(d.length>=a.fn.psu_lazyload.settings.batch_count)break}d.length>0&&a.getJSON(a.fn.psu_lazyload.settings.endpoint,{id:d},e.bind(c))}function e(b,e,f){var g=this;c=setTimeout(d,0),a.each(b,function(b,c){var d=g[b];d.addClass("psu-lazyload-complete"),d.find(".lazy-field").each(function(){var b=a(this),d=b.data("type");b.text(c[d])})})}var b=[],c=0;a.fn.psu_lazyload=function(){if(0==a.fn.psu_lazyload.settings.endpoint)return this;var e=this.each(function(){if(a(this).hasClass("psu-lazyload-complete"))return;b.push(this),0===c&&(c=setTimeout(d,500))});return e},a.fn.psu_lazyload.settings={batch_count:20,endpoint:!1},a(function(){a(".psu-lazyload").psu_lazyload()})}(jQuery),$.psu.addMessage=function(a,b){var c=$("<li/>").text(a);switch(b){case"success":b="successes";break;case"warning":b="warnings";break;case"error":b="errors";break;default:b="messages"}$("#webapp-avant-body .message-"+b).find("ul").append(c).end().show()},window.log=function(){log.history=log.history||[],log.history.push(arguments),this.console&&console.log(Array.prototype.slice.call(arguments))};/*!
=======
 */(function(a){a.root=a(document),a(function(){if(typeof HOST=="string"){var b=document.createElement("script");b.type="text/javascript",document.body.appendChild(b),b.src=HOST+"/webapp/my/js/konami.js"}typeof a.fn.dropDownMenu=="function"&&a(".webapp-nav ul:first").dropDownMenu({timer:500,parentMO:"parent-hover",childMO:"child-hover1"}),a(".webapp-nav ul ul ul").parent().children("a").addClass("menu-expand"),a.fn.tablesorter&&a("table.sortable").tablesorter()}),a("#return-to-top").live("click",function(b){b.preventDefault(),a("html, body").animate({scrollTop:0},"fast")}),a.psu=a.psu||{},function(){this.psu={host:null},typeof HOST=="string"?this.psu.host=HOST:(this.psu.host=document.location.protocol+"//",".dev.plymouth.edu"==document.location.host.substr(-17)?this.psu.host=this.psu.host+"www.dev.plymouth.edu":this.psu.host=this.psu.host+"www.plymouth.edu")}(),a.psu.addMessage=function(b,c){var d=a("<li/>").text(b);switch(c){case"success":c="successes";break;case"warning":c="warnings";break;case"error":c="errors";break;default:c="messages"}a("#webapp-avant-body .message-"+c).find("ul").append(d).end().show()},window.log=function(){log.history=log.history||[],log.history.push(arguments),this.console&&console.log(Array.prototype.slice.call(arguments))}})(jQuery);/*!
>>>>>>> Put jQuery $ into a controlled scope
...
(function(a){function e(c){function n(){c?f.removeData(c):k&&delete b[k]}function o(){g.id=setTimeout(function(){g.fn()},l)}var e=this,f,g={},h=c?a.fn:a,i=arguments,j=4,k=i[1],l=i[2],m=i[3];typeof k!="string"&&(j--,k=c=0,l=i[1],m=i[2]),c?(f=e.eq(0),f.data(c,g=f.data(c)||{})):k&&(g=b[k]||(b[k]={})),g.id&&clearTimeout(g.id),delete g.id;if(m)g.fn=function(a){typeof m=="string"&&(m=h[m]),m.apply(e,d.call(i,j))===!0&&!a?o():n()},o();else{if(g.fn)return l===undefined?n():g.fn(l===!1),!0;n()}}"$:nomunge";var b={},c="doTimeout",d=Array.prototype.slice;a[c]=function(){return e.apply(window,[0].concat(d.call(arguments)))},a.fn[c]=function(){var a=d.call(arguments),b=e.apply(this,[c+a[0]].concat(a));return typeof a[0]=="number"||typeof a[1]=="number"?this:b}})(jQuery);/*!

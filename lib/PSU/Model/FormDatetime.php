...
/**
 * A text field formatted to accept date and time strings, similar to PSU_Model_FormDate.
 *
...
{
	public $datetime_format = '%m/%d/%Y %H:%M:%S';
	...
	public function convert_datetimestring($v) {
		$v = strtotime( $v );
		return strftime( $this->datetime_format, $v );
	}

 ...
 * WordPress Error API.
 *
 * Contains the PSU_Error class and the is_wp_error() function.
 *
 * @package WordPress
 */
 ...
 * PSU_Error and use {@link is_wp_error()} to check if this class is returned.
...
class PSU_Error {
	...
	/**
	 * Static method to check if a variable is a PSU_Error.
	 */
	public static function check( $thing ) {
		if ( is_object($thing) && $thing instanceof PSU_Error )
			return true;
		return false;
	}
}

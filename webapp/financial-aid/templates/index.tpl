		...
		<table class="grid">
			<thead>
				<tr>
					...
					{/foreach}
					<th class="monetary">Total Accepted</th>
				</tr>
			</thead>
			<tbody>
...
{box size=16 title="Requirements"}
	...
	{if $unsatisfied->not_empty() || $satisfied->not_empty()}
		<p>This Requirements section will identify items which must be satisfied in order for PSU to help you obtain financial aid. Required items(s) identified under <strong>Requirements Students Need to Complete or Submit</strong> must be resolved to access all aid programs. <strong>Documents may be faxed to our office at 603-535-2627 or mailed to the PSU Financial Aid Team, Plymouth State University, 17 High Street, MSC #18, Plymouth, NH 03264</strong>. In addition, <strong>you may <a href="/office/financial-aid/contact-information/request-form/">electronically submit documents</a> using <a href="/office/financial-aid/contact-information/request-form/">our contact form</a></strong>.</p>
		<p>Once all requirements have been satisfied (and you are admitted), your file will be pulled for Director review. Files are reviewed on a once a week cycle. At that time, your award will be determined or additional information may be required for further clarification. You will receive an e-mail once your award has been completed or if additional information is required based upon our review.</p>

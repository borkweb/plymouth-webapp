		...
		<td width="100%" align="center">
			...
			<tr>
				<td width="100%" align="left">
					<h2>&#187; Call Log Statistics</h2>
					<span class="summary_text">Showing call statistics.</span>
				</td>
			</tr>
			<tr>
				<td width="100%" align="left">
			...
			<tr>
				<td width="100%" align="right"><a href="{graph_img_src}&graph_type=csv">Data in csv format</a></td>
			</tr>
			<!-- Statistic Generation Form -->
			<tr>
				<th style="text-align:left;">Experimental Statistic Generating Form</th>
			</tr>
			<tr>
				<td>
				<form id="StatForm" name="StatForm" action="statistics.html">
					<select name="statistic">
						...
						<!-- <option value="top_remote_loggers" {top_remote_loggers_selected}>Top Remote Loggers</option> -->
						...
						<optgroup label="Calls">
							...
							<!-- <option value="calls_by_location" {calls_by_location_selected}>By Location</option> -->
					...
					<br />
					<div id="date_drop_down" style="visibility:hidden; margin-top:1ex; float:left;">
						{begin_date_select} through {end_date_select}
					</div><br />
					<a href="javascript:document.StatForm.submit()" class="action">Generate Statistics</a>
				</form>
				</td>
			</tr>
			<!-- End of Statistic Generation Form -->
			<tr>
				<td>

...
<tr>
	<td width="100%" align="center" valign="middle" colspan="2">
		<!-- BEGIN: add_keyword -->
		<a href="javascript:document.add_edit_keyword.submit()" title="Add Keyword." class="action button">Add Item</a>
		<!-- END: add_keyword -->
		<!-- BEGIN: update_keyword -->
		<a href="javascript:document.add_edit_keyword.submit()" title="Update Keyword." class="action button">Update Keyword</a>
		<!-- END: update_keyword -->		
		&nbsp;&nbsp;
